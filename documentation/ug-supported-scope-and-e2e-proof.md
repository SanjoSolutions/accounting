...
4. Incoming PDF text extraction and EN-16931 UBL/CII/hybrid-PDF intake with
   ...
   A separate narrow intra-community acquisition path accepts 19% EUR goods
   invoices with EN16931 category `K`, exact foreign-EU supplier and tenant-
   bound German VAT IDs, structured German delivery destination, explicit
   acquisition date, zero supplier VAT, and explicit operator confirmation of
   ordinary goods used wholly for taxable business activity. Dedicated active-
   chart acquisition controls post equal acquisition/output and deductible
   input VAT while the supplier payable remains net.
...
The intra-community acquisition path is limited to ordinary 19% goods that
actually travel from another EU VAT territory to Germany. It rejects services,
domestic/third-country/Northern-Ireland suppliers, foreign VAT, missing German
delivery evidence, invoice dates before acquisition, 7%/0%/mixed or exempt
goods, new vehicles, excise goods, margin schemes, triangulation and chain
transactions, own-goods transfers, advance/final invoices, adjustments,
partial/private/exempt use, foreign currency, and acquisition-threshold or
Kleinunternehmer cases. Its tax point follows [§ 13(1)(6)
UStG](https://www.gesetze-im-internet.de/ustg_1980/__13.html): invoice date,
but no later than the end of the month after acquisition. Eligibility and place
are pinned to [§ 1a UStG](https://www.gesetze-im-internet.de/ustg_1980/__1a.html)
and [§ 3d UStG](https://www.gesetze-im-internet.de/ustg_1980/__3d.html), input
deduction to [§ 15(1)(3)
UStG](https://www.gesetze-im-internet.de/ustg_1980/__15.html), and KZ 89/KZ 61
to the [official BMF 2026 UStVA form and
instructions](https://www.bundesfinanzministerium.de/Content/DE/Downloads/BMF_Schreiben/Steuerarten/Umsatzsteuer/2025-12-29-vordruckmuster-USt-voranmeldung-2026.pdf?__blob=publicationFile&v=7).
...
| UG-AP-EU-GOODS-01 | For ordinary 19% EUR goods transported from another EU VAT territory to Germany, require whole-invoice EN16931 `K`, structured German delivery evidence, exact acquisition and invoice dates, foreign supplier and tenant-bound German VAT IDs, zero supplier VAT, explicit fully taxable business-use confirmation, and separate configured acquisition controls. Apply the §13(1)(6) invoice-date/following-month cap, retain the net supplier payable, and produce only KZ 89 base plus KZ 61 deductible input-VAT provenance. | `eu-supplier-goods-acquisition-real.spec.ts` proves the no-mock visible settings, genuine Dutch UBL upload/review, explicit classification/rate, balanced four-line journal, evidence, supplier payable, VAT API and reload journey. BDD UBL/CII parser, domain, UI, API, settings and migrated-SQLite tests prove German delivery extraction, the other-26-member allowlist with GR/EL VAT semantics, 19%/full-deduction boundary, separate controls, invoice/acquisition tax-point cap, zero-residue advance rejection, tenant VAT binding, VAT-ID supplier identity, exact replay, durable canonical VAT restoration, KZ 89/KZ 61 UStVA preparation, and absence of KZ 93. |

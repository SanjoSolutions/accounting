...
export const taxFormRegistry = new FormRegistry([
  ...(['USTVA', 'UST_ANNUAL', 'KST', 'GEWST'] as DeclarationKind[]).map(kind => ({ kind, version: `${kind}-2025.1`, validFrom: '2025', validTo: '2025', requiredFields: ['USTVA', 'UST_ANNUAL'].includes(kind) ? ['ZAHLLAST'] : kind === 'KST' ? ['STEUERLICHES_ERGEBNIS'] : ['GEWERBEERTRAG', 'GEMEINDE', 'HEBESATZ_BP'], fieldNames: {} })),
